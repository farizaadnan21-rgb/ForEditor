...
Modern lightweight image editor built with Python Tkinter.  
Designed with a modern dark interface
...
- 🌡 Temperature effect (Blue / Yellow)
- 🧹 Noise reduction
...
- Improve desktop application design
- Build portfolio-ready software projects
