...
class ForEditorApp:
    def __init__(self, root):
        self.root = root
        self.root.title("ForEditor — Studio")
    ...
    def setup_ui(self):
        ...
        tk.Label(
            header, text="🖌️ ForEditor", bg=self.c["bg_sidebar"],
            font=self.font_title, fg=self.c["text"],
        ).pack(anchor="w")
        tk.Label(
            header, text="Lightweight image editor · portfolio ready", bg=self.c["bg_sidebar"],
